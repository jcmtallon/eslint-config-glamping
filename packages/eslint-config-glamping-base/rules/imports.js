  ...
  rules: {
    ...
    'import/order': ['warn', {
      groups: [
        ...
        'index',
        'object',
        // We don't include 'type' so types imported via 'import type' are placed
      ...
      // pathGroupsExcludedImportTypes defaults to ["builtin", "external"], which can
      // cause confusion when setting up pathGroups, so we reset the value
